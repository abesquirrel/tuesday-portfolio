...
INSERT OR IGNORE INTO photos
  (id, public_id, title, caption, roll, location, medium, simulation, camera, lens, film_stock, sort_order, is_featured)
VALUES
  (
    'featured',
    ...
    'Roll 01', 'Queens, NY', 'film', NULL, 'Nikkormat FT2', 'Nikon 50mm f/1.4', 'Kodak Color 200', 0, 1
  ),
  (
    'photo-01',
    ...
    'Roll 01', 'Brooklyn, NY', 'film', NULL, 'Nikkormat FT2', 'Nikon 50mm f/1.4', 'Kodak Color 200', 1, 0
  ),
  (
    'photo-02',
    ...
    'Roll 02', 'Chicago, IL', 'film', NULL, 'Nikkormat FT2', 'Nikon 28mm f/2.8', 'Kodak Tri-X 400', 2, 0
  ),
  (
    'photo-03',
    ...
    'Roll 02', 'Chicago, IL', 'digital', 'Classic Chrome', 'Fujifilm X-T20', 'Fujifilm 35mm f/2', NULL, 3, 0
  ),
  (
    'photo-04',
    ...
    'Roll 03', 'Detroit, MI', 'digital', 'Acros', 'Fujifilm X-T20', 'Fujifilm 35mm f/2', NULL, 4, 0
  ),
  (
    'photo-05',
    ...
    'Roll 03', 'Detroit, MI', 'film', NULL, 'Nikkormat FT2', 'Nikon 50mm f/1.4', 'Kodak Portra 400', 5, 0
  ),
  (
    'photo-06',
    ...
    'Roll 04', 'Pittsburgh, PA', 'film', NULL, 'Nikkormat FT2', 'Nikon 50mm f/1.4', 'Ilford HP5 Plus', 6, 0
  ),
  (
    'photo-07',
    ...
    'Roll 04', 'Pittsburgh, PA', 'digital', 'Eterna Cinema', 'Fujifilm X-T20', 'Fujifilm 23mm f/2', NULL, 7, 0
  ),
  (
    'photo-08',
    ...
    'Roll 05', 'Cleveland, OH', 'film', NULL, 'Nikkormat FT2', 'Nikon 50mm f/1.4', 'Kodak Gold 200', 8, 0
  );
